...
HD_PWD='E:/Elementary/Facultad/Arquitectura/TPFinal/TPFinal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TPF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TPF.tcl
