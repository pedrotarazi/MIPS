...
HD_PWD='E:/Elementary/Facultad/Arquitectura/TPFinal/TPFinal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TPF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TPF.tcl -notrace
